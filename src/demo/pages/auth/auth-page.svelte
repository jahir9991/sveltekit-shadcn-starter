<script lang="ts">
	import AuthForm from '$src/demo/pages/auth/authForm.svelte';
</script>


<div
	class=" relative   flex-col items-center justify-center md:grid lg:max-w-none lg:grid-cols-2 lg:px-0"
>
